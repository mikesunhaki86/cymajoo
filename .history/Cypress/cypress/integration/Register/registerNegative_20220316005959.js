...
describe('Register Negative', () => {
    it('As a user, i want to register with some empty field', () => {
        // Verify screen
        expect('Student Registration Form').to.exist

        cy.get(elements.TXT_FIRST_NAME).click()
        cy.get(elements.TXT_LAST_NAME).click()
        // Leave first name and last name field empty

        cy.get(elements.TXT_EMAIL).click()
        ...
        cy.get(elements.TXT_MOBILE_NUMBER).click()
        // Leave mobile number field empty
